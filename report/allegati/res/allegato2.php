<page  style="font-size:12px" backtop="5mm" backleft="5mm" backright="5mm" backbottom="9mm">
...
<page_footer>
    ...
    <img src="<?=$_SERVER['DOCUMENT_ROOT']?>ERP/docs/veicoli/allegati/<?=$all['nome_file2']?>" style="width:100%;text-align:center;">
